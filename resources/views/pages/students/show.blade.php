...
<script src="/js/pages/students/categorical-insights.js"></script>    
@endsection
        ...
        <div class="col-lg-12">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-categorical-insights">
                        @include('pages.students.profile.categorical-insights')
                    </div><!-- /.tab-pane -->
